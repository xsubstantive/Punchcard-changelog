  ...
  return (
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          "bg-popover text-popover-foreground h-(--radix-navigation-menu-viewport-height) ring-border md:w-(--radix-navigation-menu-viewport-width) shadow-black/6.5 relative mt-1.5 w-full origin-top overflow-hidden rounded-xl p-0.5 shadow-xl ring-1 transition-[width,height] duration-200",
